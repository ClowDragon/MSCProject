...
## Import the sample covariance matrxi computed by the Desroziers diagnostic
#Variables
#Outputs:
...
#import necessary libraries
    ...
    while line[0] == '!': #skip over comments (lines starting with !) and store when the data starts in variable startline\n",
        line = fp.readline()
...
#Initialise our vectors and matrices based on the extracted parameters\n",
    sigmalist_raw = np.zeros(Channelnos_raw) #set up vector where variances will be stored - this will then be converted to a diagonal matrix\n",
